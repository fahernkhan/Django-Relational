...
def write_instructor():
    ...
    # Update the user reference of instructor_john to user_john
...
def write_learners():
    ...
    learner_kafa = Learner(first_name='Fafa', last_name='Salsa', dob=date(2023, 2, 24),
                           occupation='developer', social_link='https://www.linkedin.com/fafa')
    learner_kafa.save()
